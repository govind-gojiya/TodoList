...
// checkTime Function To Make To digit Number Which Less Then 10
...
function showtask() {
    ...
    taskObj.forEach((item, index) => {
        ...
        html += `<tr>
                    ...
                    ${taskCompleteValue}
                    <td><button type="button" onclick="edittask(${index})" class="text-primary"><span class="iconify" data-icon="icon-park:edit-two" data-inline="false"></span> Edit</button></td>
                    <td><button type="button" class="text-success" id=${index}><span class="iconify" data-icon="emojione:hourglass-done" data-inline="false"></span> Complete</button></td>
                    <td><button type="button" onclick="deleteitem(${index})" class="text-danger"><span class="iconify" data-icon="icon-park:delete" data-inline="false"></span> Delete</button></td>
                </tr>`;
    });
